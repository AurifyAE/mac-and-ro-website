                    ...
                    >
                        ...
                        >
                            ...
                            {[
                                ...
                                { href: "https://www.instagram.com/mac_and_ro_capital_fzc/", icon: instagram, label: "Instagram", title: "Instagram" }
                            ].map((item, index) => item ? (
                                <motion.a
                                    key={index}
                                    href={item.href}
                            ...
                            {/* Row 2 */}
                            {[
                                { href: "https://www.facebook.com/MacandroCapitalFzc", icon: facebook, label: "Facebook", title: "Facebook" },
                                { href: "https://mac-ro-capital.com", icon: globe, label: "Website", title: "Website" },
