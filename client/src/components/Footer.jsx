    ...
    return (
            ...
            <div className="max-w-6xl mx-auto px-4">
                <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
                    ...
                    <form onSubmit={handleSubscribe} className="space-y-4">
                        ...
                        >
                            <img src={send} alt="" width="16" height="16" className="w-4 h-4" />
                        </button>
                        </div>
        ...
        <section className="py-5 md:py-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                {/* Logo */}
                <div className="mb-4">
                    <img src={logo} alt="Mac &amp; Ro Capital" width="128" height="48" loading="lazy" decoding="async" className="h-12" />
                </div>
                    ...
                    <div className="tooltip-container">
                        <div className="w-24 h-auto bg-white rounded relative group cursor-pointer">
                            <Link 
                                ...
                                target='_blank'
                            >
                                <img src={googlePlay} alt="Get it on Google Play" width="124" height="35" loading="lazy" decoding="async" className="w-24 h-auto" />
                            </Link>
                        </div>
                    </div>
                    <div className="tooltip-container">
                        <div className="w-24 h-auto bg-white rounded relative group cursor-pointer">
                            <Link
                                ...
                                target="_blank"
                            >
                                <img src={appStore} alt="Download on the App Store" width="107" height="35" loading="lazy" decoding="async" className="w-24 h-8" />
                            </Link>
                        </div>
                    </div>
                    </div>
                ...
                <div>
                    ...
                    {/* These four links were SVG-only, so screen readers announced them
                        as bare "link" — the failing elements in the Lighthouse "Links do
                        not have a discernible name" audit. Note: the LinkedIn and YouTube
                        entries below still point at "#" and go nowhere; per your call
                        they keep the placeholder href for now, so swap in the real URLs
                        when you have them. */}
                    <Link to="https://www.instagram.com/mac_and_ro_capital_fzc" target="_blank" rel="noopener noreferrer" aria-label="Mac & Ro Capital on Instagram" className="text-black hover:text-[#DCBC7C] transition-colors">
                    ...
                    <Link to="#" aria-label="Mac & Ro Capital on LinkedIn" className="text-black hover:text-[#DCBC7C] transition-colors">
                        <svg className="w-6 h-6" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                        </svg>
                    </Link>
                    <Link to="https://www.facebook.com/MacandroCapitalFzc" target="_blank" rel="noopener noreferrer" aria-label="Mac & Ro Capital on Facebook" className="text-black hover:text-[#DCBC7C] transition-colors">
                        <svg className="w-6 h-6" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                        </svg>
                    </Link>
                    <a href="#" aria-label="Mac & Ro Capital on YouTube" className="text-black hover:text-[#DCBC7C] transition-colors">
                    <svg className="w-6 h-6" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="max-w-6xl mx-auto px-4">
                <div className="flex justify-between items-center">
                    ...
                    <div className="flex items-center space-x-2">
                        <img src={visa} alt="Visa" width="48" height="24" loading="lazy" decoding="async" className="w-12 h-6 object-cover rounded-md grayscale" />
                        <img src={mastercard} alt="MasterCard" width="48" height="24" loading="lazy" decoding="async" className="w-12 h-6 object-cover rounded-md grayscale" />
                        <img src={bankTransfer} alt="Bank Transfer" width="48" height="24" loading="lazy" decoding="async" className="w-12 h-6 object-cover rounded-md grayscale" />
                    </div>
                </div>
            </div>
        </div>
